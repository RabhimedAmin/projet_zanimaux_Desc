 ...
 * @author USER-PC
 */
public class FXML_indexContentController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            AnchorDrower=FXMLLoader.load(getClass().getResource("FXML_DrawerNotConnected.fxml"));
                                ...
                                register.setTitle("Register - new account");
                                
                                        {
                                            try {
                                                ...
                                                anchor1 = FXMLLoader.load(getClass().getResource("FXML_RegisterScrean.fxml"));
                                                Scene log=new Scene(anchor1);
                                                register.setScene(log);
                                                register.showAndWait();
                                            } catch (IOException ex) {
                                                Logger.getLogger(FXML_indexContentController.class.getName()).log(Level.SEVERE, null, ex);
                                            }
                                        }
                                        break;
                        case "login":
                            ...
                            drawer.close();
                                        {
                                            try {
                                                ...
                                                anchor2 = FXMLLoader.load(getClass().getResource("FXML_login.fxml"));
                                            ...
                                            if (UserService.isLogedIn(currentUser))
                                            {
